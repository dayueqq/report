<?php /* Smarty version Smarty-3.0.6, created on 2013-11-22 03:44:59
         compiled from "./adsInfo.html" */ ?>
<?php /*%%SmartyHeaderCode:10054528ed33bf11dd9-40929372%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '10054528ed33bf11dd9-40929372',
  'function' => 
  array (
  ),
...
" target="_blank">打开链接</a></td>
              ...
              <td width="5%"><a onclick="return confirm('是否清空此排期?')" href="operation.php?action=resetads&placeid=<?php echo $_smarty_tpl->getVariable('info')->value[$_smarty_tpl->getVariable('smarty')->value['section']['info_id']['index']]['placeid'];?>
