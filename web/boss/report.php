<?php
  ...
  if(isset($_GET['detail'])){
	  ...
	  switch($detail){
		  case 'staff':
		               $sql="select * from report where name='$term'";
					   break;
		  case 'place':
		               $sql="select * from report where place='$term'";
					   break;
		  case 'time':
		               $sql="select * from report where time='$term'";
					   break;
	  }
  }else{
	  if(isset($_GET['order'])){
		  ...
		  if($order=='default'){
			  ...
			  $sql="select * from report order by $order desc";
		  }
	  }else{
		  $sql="select * from report order by report_id desc";
	  }
